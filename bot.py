...
OWNER_ID = 8232776469  # только этот пользователь может добавлять тексты

DATA_FILE = "links.json"

DEFAULT_TEXT = "Bot принадлежит каналу Mr.Script"
...
async def add_link(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if update.effective_user.id != OWNER_ID:
        return  # игнорируем всех, кроме владельца
